...
/**
 * {@code Object#toString()} helper class.
 *
 * @author Fuchun
 * @since 1.0, Guava 18.0 (MoreObjects.ToStringHelper)
 */
public class ToString {
     ...
     * @since Guava 18.0
     */
    public static ToStringHelper helper(Object self) {
        return new ToStringHelper(self.getClass().getSimpleName());
    }

    /**
     * Creates an instance of {@link ToStringHelper} in the same manner as {@link
     * #helper(Object)}, but using the simple name of {@code clazz} instead of using an
     ...
     * @since Guava 18.0
     */
    public static ToStringHelper helper(Class<?> clazz) {
        return new ToStringHelper(clazz.getSimpleName());
    }

    /**
     * Creates an instance of {@link ToStringHelper} in the same manner as {@link
     * #helper(Object)}, but using {@code className} instead of using an instance's {@link
     * Object#getClass()}.
     *
     * @param className the name of the instance type
     * @since Guava 18.0
     */
    public static ToStringHelper helper(String className) {
        return new ToStringHelper(className);
    }

    /**
     * Support class for {@link ToString#helper}.
     *
     * @author Jason Lee
    ...
    public static final class ToStringHelper {
        ...
        /**
         * Use {@link ToString#helper(Object)} to create an instance.
         */
